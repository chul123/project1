	...
	<div class="container-md">
		<div class="row" style="width:820px">
			...
			<div class="col-2" style="text-align:right;">
				<div class="btn-group" role="group" aria-label="Basic outlined example">
					<input type="button" class="btn btn-outline-danger" value="삭제" style="width:90px;"
					 onclick="/board/remove${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${boardVO.bno }'">
				</div>
			</div>
		</div>
	</div>
...
<div class="container-md">
	<div class="row" style="width:820px">
		<div class="input-group mb-3">
			<span class="input-group-text" name="replyer" id="newReplyWriter" style="width:150px;">${sessionScope.id }</span>
