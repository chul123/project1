        ...
        <table class="news-table">
            ...
            <tr>
                <td style="vertical-align: top;">
                    <c:if test="${not empty news.imageFileNames}">
                        <img src="${pageContext.request.contextPath}/img/${news.imageFileNames}" alt="News Image" class="news-image">
                    </c:if>
                </td>
            </tr>
            <tr>
            ...
            <tr>
		        <td style="text-align: right; padding-top: 10px;">
				    <a href="news?page=${pageMaker.cri.page}" class="btn btn-outline-dark">돌아가기</a>
				</td>
	        </tr>
        </table>
    </div>
        	...
        	<tr>
                <td>
                    ...
                    <div class="emotion-analysis">
                        <p class="sentiment-text ${news.sentimentPrediction == '긍정' ? 'positive' : (news.sentimentPrediction == '부정' ? 'negative' : 'neutral')}">
