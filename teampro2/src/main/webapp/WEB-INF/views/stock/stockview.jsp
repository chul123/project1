	...
	<hr><br><br>
	    <div class="row">
	        <div class="col-sm-2 mb-4">
	            <div>
	                <form method="POST" action="http://192.168.0.29:5000/prediction_kr" onsubmit="return handleFormSubmit()">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="chart-container" style="width: 100%; overflow-x: auto;">
                <iframe src="http://192.168.0.29:5000/stock_graph?stockcode=${stock.stockcode}" width="100%" height="600" frameborder="1"></iframe>
            </div>
        </div>
    </div>
    <br><br><br><br><br>
