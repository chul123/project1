...
<table class="table table-hover" style="width: 1000px; text-align: center; margin-top: 30px;">
	<tr>
		<th>번호</th>
		<th>제목</th>
		<th>작성자</th>
    ...
    <c:when test="${empty boardResults}">
        <tr>
            <td colspan="5" class="search-message" style="text-align: center;">검색어 '${keyword}'에 대한 게시글이 없습니다.</td>
        </tr>
    </c:when>
    <c:otherwise>
